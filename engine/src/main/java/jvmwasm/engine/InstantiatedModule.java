...
import jvmwasm.format.instructions.Instr;
...
final class InstantiatedModule implements WasmModule {
	...
	@Override
	public synchronized @Nullable WasmExport getExport(String name) throws Throwable {
	...
	private WasmExport createExport(ExportDesc export) throws Throwable {
