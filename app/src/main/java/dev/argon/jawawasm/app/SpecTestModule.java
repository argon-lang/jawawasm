...
class SpecTestModule implements WasmModule {
	...
	public SpecTestModule(Engine engine, PrintWriter output) {
		...
		exports.put("table", new WasmTable(new TableType(new Limits(10, 20), new RefType(true, HeapType.AbstractHeapType.FUNC))));
	...
	@Override
	public @Nullable WasmExport getExport(String name) {
