...
public final class Util {
	...
	public static void initArrayFromData(short[] array, byte[] data, int s, int n) {
		Objects.checkFromIndexSize(s, n, data.length / n);
		for(int i = 0; i < n; ++i) {
			array[i] = (short)((data[s + i * 2] & 0xFF) | ((data[s + i * 2 + 1] & 0xFF) << 8));
		}
	}

	public static void initArrayFromData(int[] array, byte[] data, int s, int n) {
		Objects.checkFromIndexSize(s, n, data.length / n);
		for(int i = 0; i < n; ++i) {
			array[i] = (data[s + i * 4] & 0xFF) |
				((data[s + i * 4 + 1] & 0xFF) << 8) |
	...
	public static void initArrayFromData(float[] array, byte[] data, int s, int n) {
		Objects.checkFromIndexSize(s, n, data.length / n);
		for(int i = 0; i < n; ++i) {
	...
	public static void initArrayFromData(long[] array, byte[] data, int s, int n) {
		Objects.checkFromIndexSize(s, n, data.length / n);
		for(int i = 0; i < n; ++i) {
			array[i] = (long)(data[s + i * 8] & 0xFF) |
	...
	public static void initArrayFromData(double[] array, byte[] data, int s, int n) {
		Objects.checkFromIndexSize(s, n, data.length / n);
		for(int i = 0; i < n; ++i) {
			array[i] = Double.longBitsToDouble(
